...
def args():
    ...
    parser.add_argument("--gpu", type=int, default=1, help="the cuda number")
    parser.add_argument("--n_epochs", type=int, default=20, help="number of epochs of training")
    parser.add_argument("--dataset_name", type=str, default="CelebA", help="name of the dataset")
    parser.add_argument("--dataset_dir", type=str, default='../stargan/CelebA', help="number of epochs of training")
